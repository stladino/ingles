...
const comparisonsLevel1 = [
    { subject1: "A lion", subject2: "a cat", question: "Is the lion more?", options: ["bigger", "biggest"], answer: "bigger" },
    { subject1: "A cheetah", subject2: "a rabbit", question: "Is the cheetah more?", options: ["faster", "fastest"], answer: "faster" },
    { subject1: "An elephant", subject2: "a mouse", question: "Is the elephant more?", options: ["larger", "largest"], answer: "larger" }
];

const comparisonsLevel2 = [
    { sentence: "A skyscraper is ___ than a house.", options: ["higher", "wider", "smaller"], answer: "higher" },
